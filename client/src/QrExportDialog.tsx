...
export function QrExportDialog({ open, partyName, guestUrl, qrDataUrl, onClose }: QrExportDialogProps) {
  ...
  return (
    ...
    >
      ...
      <p className="qr-export-intro">Gestalte ein druckfertiges A4-Plakat oder einen Kartenbogen zum Ausschneiden.</p>
        ...
        <div className="qr-export-options">
          <fieldset>
            ...
            <label htmlFor="qr-layout-poster" className={layout === "poster" ? "choice-card choice-card--active" : "choice-card"}>
              ...
              <strong>A4-Plakat</strong><small>Ein großer QR-Code für Eingang oder Wand</small>
            </label>
            <label htmlFor="qr-layout-cards" className={layout === "cards" ? "choice-card choice-card--active" : "choice-card"}>
              ...
              <strong>Kartenbogen</strong><small>Mehrere Exemplare mit feinen Schnittlinien</small>
            </label>
          </fieldset>
          ...
          <fieldset>
            ...
            <label htmlFor="qr-tone-mono" className={tone === "mono" ? "choice-card choice-card--active" : "choice-card"}>
              ...
              <strong>Schwarzweiß / Laser</strong><small>Wenig Toner, klare Linien, maximaler Kontrast</small>
            </label>
          </fieldset>
        </div>
      </div>
      ...
      <p className="qr-export-privacy">Die Dateien werden lokal in deinem Browser erstellt. Der Gast-Link wird an keinen zusätzlichen Dienst übertragen.</p>
